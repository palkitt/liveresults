              ...
              <td>
                ...
                <form name="form1" action="editRunner.php?compid=<?= $runner['tavid'] ?>&dbid=<?= $runner['dbid'] ?>" method="post">
                  ...
                  <table>
                    <tr>
                      <td><b>CompID</b></td>
                      <td><input type="number" name="compid" size="20" disabled="true" value="<?= $runner['tavid'] ?>" /></td>
                    </tr>

                    <tr>
                      <td><b>ID</b><br />
                      <td><input type="number" name="dbid" size="20" disabled="true" value="<?= $runner['dbid'] ?>" /></td>
                    </tr>

                    <tr>
                      <td><b>Bib</b></td>
                      <td><input type="text" name="bib" size="20" value="<?= $runner['bib'] ?>" /></td>
                    </tr>

                    <tr>
                      <td><b>Name</b></td>
                      <td><input type="text" name="name" size="20" value="<?= $runner['name'] ?>" /></td>
                    </tr>

                    <tr>
                      <td><b>Club</b></td>
                      <td><input type="text" name="club" size="20" value="<?= $runner['club'] ?>" /></td>
                    </tr>

                    <tr>
                      <td><b>Class</b></td>
                      <td><input type="text" name="class" size="20" value="<?= $runner['class'] ?>" /></td>
                    </tr>
                    ...
                    <tr>
                      <td><b>Status</b></td>
                      <td><input type="text" name="status" size="20" value="<?= $runner['status'] ?>" /> 0=OK; 1=DNS; 2=DNF; 3=DSQ; 10=Entered; 13=Finished</td>
                    </tr>

                    <tr>
                      <td><b>Checked</b><br />
                      <td><input type="checkbox" name="ecardchecked" <?= $runner['ecardchecked'] == 1 ? "checked" : "" ?> /></td>
                    </tr>

                    <tr>
                      <td><b>PIN code</b></td>
                      <td><input type="number" name="pin" size="20" value="0000" /></td>
                    </tr>
                  </table>
