...
<html>
<head><title>LiveRes Test Results</title>
...
updateTable = function(data)
{
  ...
  columns.push({ "sTitle": "Tid", "sClass": "right", "bSortable": true, "aTargets": [col++], "mDataProp": "result", 
      "render": function (data, type, row) {
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    <td class="searchmenu" colspan="2" style="padding: 5px;">
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><h1 class="categoriesheader">Resultater fra 2/3000 m løpstester</h1></td>
        </tr>
        <tr>
      ...
      <tr valign=top>
        <td> 
          <table width="100%" cellpadding="3px" cellspacing="0px" border="0" >
            <tr valign=top><tr><td><table id="testresults"></table></td></tr>
          </table>
        </td>
      </tr> 
    </table>
