...
//Language-ressource file: Русский = Russian
//translated by ieva, eMail: ###

//missing translations (to implement):
//Namn = Competition
//Arrangör = Organiser
...
$_UP15SEK = "Каждые 15 секунд";
$_UP15SEK = "Каждые 30 секунд";
$_UP60SEK = "Раз в минуту";
$_UP120SEK = "Каждые две минуты";
$_UPNEVER = "Никогда";
...
//the $_NOTICE is not displayed any more in any language?$_STATUSOK = "Passed";
$_STATUSDNS = "dns";
$_STATUSDNF = "dnf";
$_STATUSMP = "mp";
$_STATUSDSQ = "disq";
...
$_FIRSTPAGEARCHIVE = "Архив"; // where is this used?
$_FIRSTPAGELIVE = "Онлайн";
...
$_OPENINNEWWINDOW = "Открыть в новом окне"; // duplicate with $_OPENINNEW?
